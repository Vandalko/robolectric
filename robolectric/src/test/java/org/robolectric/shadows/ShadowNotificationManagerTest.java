...
public class ShadowNotificationManagerTest {
  ...
  @Test
  @Config(minSdk = Build.VERSION_CODES.Q)
  public void testCanNotifyAsPackage_True_when_notification_delegate_Set() throws Exception {
    String pkg = "some.package";
    notificationManager.setNotificationDelegate(pkg);
    assertThat(notificationManager.canNotifyAsPackage(pkg)).isTrue();
  }

  @Test
  @Config(minSdk = Build.VERSION_CODES.Q)
  public void testCanNotifyAsPackage_False_when_other_delegate_set() throws Exception {
    notificationManager.setNotificationDelegate("some.package");
    assertThat(notificationManager.canNotifyAsPackage("other.package")).isFalse();
  }

  @Test
  @Config(minSdk = Build.VERSION_CODES.Q)
  public void testCanNotifyAsPackage_False_when_no_delegate_set() throws Exception {
